...
namespace UnitTest_1_10
{
    ...
    public class UnitTests_1_10
    {
        ...
        {
            Assert.AreEqual(it_is_good_triangle(5, 3, 7 ), true, "Side_a_plus_side_b_NOT_more_then_side_c");
        }
        ...
        {
            Assert.AreEqual(it_is_good_triangle(7, 3, 8), true, "Side_a_plus_side_c_NOT_more_then_side_b");
        }
