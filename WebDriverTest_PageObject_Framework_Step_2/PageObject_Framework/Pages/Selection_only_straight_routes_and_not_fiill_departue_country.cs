...
{
    public class Selection_only_straight_routes_and_not_fiill_departue_country
    {
        ...
        public IWebElement selectPlusMinusTwoDays{ get; set; }
        //[FindsBy(How = How.ClassName, Using = "nemo-flights-results__matrix__table__cell_cheapest")]
        //public IWebElement selectAnyItem { get; set; }
        [FindsBy(How = How.ClassName, Using = "nemo-flights-results__error__footer__button")]
        public IWebElement selectAnyItem { get; set; }
        //[FindsBy(How = How.ClassName, Using = "ui-dialog-titlebar-close")]
        //public IWebElement closeEmergedWindow { get; set; }
        ...
        public Selection_only_straight_routes_and_not_fiill_departue_country(IWebDriver browser)
        {
            driver = browser;
