...
{
    public class Selection_only_straight_routes_use_undo_button
    {
        ...
        public IWebElement selectButtonEdit { get; set; }
        [FindsBy(How = How.ClassName, Using = "nemo-flights-form__searchBlockedError")]
        public IWebElement returnMessage { get; set; }
        //[FindsBy(How = How.ClassName, Using = "nemo-flights-results__flightsGroup__buyButton")]
        //public IWebElement buttonBuy { get; set; }
        //[FindsBy(How = How.XPath, Using = "//div[@class='nemo-ui-textInput__input js-checkout-customer-field'][2]")]
        //public IWebElement lastName { get; set; }
        //[FindsBy(How = How.ClassName, Using = "new-flights-passInfo__footer__button_buy']")]
        //public IWebElement buttonReservation { get; set; }

        public Selection_only_straight_routes_use_undo_button(IWebDriver browser)
        {
            driver = browser;
