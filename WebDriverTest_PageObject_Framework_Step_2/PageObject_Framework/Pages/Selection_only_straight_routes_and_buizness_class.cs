...
{
    public class Selection_only_straight_routes_and_buizness_class
    {
        ...
        public IWebElement typeTicket { get; set; }
        [FindsBy(How = How.XPath, Using = "//*[text()='Бизнес']")]
        public IWebElement selectBuzinesTickets { get; set; }
        ...
        public Selection_only_straight_routes_and_buizness_class(IWebDriver browser)
        {
            driver = browser;
